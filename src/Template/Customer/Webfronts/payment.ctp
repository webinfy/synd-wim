                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="webfront">                                    
                                    <div class="webfront_main">
                                        <div class="web_left" style="width: 30% !important;">
                                            <div class="bnnr profile_cont"> <img  src="<?= WEBFRONT_LOGO . $webfront->logo ?>" width="270" height="280"> </div>
                                        ...
                                        <div class="web_right" style="width: 70% !important;"> 
                                            <h2 class="head">
                                                <span> Payment Description </span>                                                
                                            </h2>
                                            <div style="clear: both;">&nbsp;</div>
                                            <div class="wbfrnt_desc"><?= $webfront->description ?></div>  
                                            <?php if (!empty($this->request->pass[1])) { ?>
                                                <div class="wbfrnt_paynow"><a href="<?= HTTP_ROOT . "customer/pay-now/" . $this->request->pass[1] ?>" class="pay_btn" >Pay Now </a></div>                                          
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
