...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Login Page - Syndicate Bank - Synd Collect</title>
                                            ...
                                            <fieldset>
                                                <label class="block clearfix">
                                                    <span class="block input-icon input-icon-right">
                                                        <?php echo $this->Form->input('reference_number', ['type' => 'text', 'class' => 'form-control', 'label' => FALSE, 'placeholder' => 'Ref No.', 'required' => TRUE]); ?>
