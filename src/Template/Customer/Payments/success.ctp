                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="content-main-area">
                                        ...
                                        <!--<th>Convenience Fee</th> -->
                                            ...
                                            <?php
                                            $colspan = count($paymentCustomFields) + (!empty($payment->late_fee_amount) ? 1 : 0);
                                            $colspanShow = $colspan - 1;
                                            ?>
                                            <tr>
                                                <td colspan="<?= $colspanShow ?>" style="color: #155092;font-weight: bold;font-size: 15px;text-align: right;">Total Amount</td>
                                                <td colspan="1" style="font-weight: bold;">Rs. <?= ($payment->paid_amount) ?></td>
                                            </tr>
                                        </table>                                 
                                    </div>    
                                </div><!-- /.row -->     
