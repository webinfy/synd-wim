                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="webfront">                                    
                                    <div class="webfront_main">
                                        <div class="web_left">
                                            <div class="bnnr profile_cont"> <img  src="<?= WEBFRONT_LOGO . $webfront->logo ?>"> </div>
                                        ...
                                        <div class="web_right"> 
                                            ...
                                            <?php if (!empty($this->request->pass[1])) { ?>
                                                <div class="wbfrnt_paynow"><a href="<?= HTTP_ROOT . "webfronts/pay-now/" . $this->request->pass[0] ?>" class="pay_btn" >Pay Now </a></div>                                          
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
