...
class CustomComponent extends Component {
    ...
    function sendSMS($phone, $message, $type = 'transactional') {

        $phone = trim($phone);
        $message = urlencode($message);

        $apiUrl = "https://www.payumoney.com/Asynctaskprocessor/smarthub/sendSms?phone={$phone}&text={$message}&type=$type&application=SYNCOLLECT";
        $ch = curl_init();
    ...
    <tbody>
        ...
        <td><table width="750" border="0" cellspacing="0" cellpadding="0">
            <tbody>
            <tr>
                <td><img alt="" src="' . HTTP_ROOT . 'img/logo.png"/</td>
